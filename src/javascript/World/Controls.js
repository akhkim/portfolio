...
export default class Controls extends EventEmitter
{
    ...
    setTouch()
    {
        ...
        this.touch.left.$element.style.bottom = '15px'
        this.touch.left.$element.style.left = '15px'
        this.touch.left.$element.style.width = '70px'
        this.touch.left.$element.style.height = '70px'
        this.touch.left.$element.style.transition = 'opacity 0.3s 0.1s'
        ...
        this.touch.left.$icon.style.top = 'calc(50% - 11px)'
        this.touch.left.$icon.style.left = 'calc(50% - 9px)'
        this.touch.left.$icon.style.width = '18px'
        this.touch.left.$icon.style.height = '22px'
        ...
        this.touch.right.$element.style.bottom = '15px'
        this.touch.right.$element.style.left = '100px'
        this.touch.right.$element.style.width = '70px'
        this.touch.right.$element.style.height = '70px'
        this.touch.right.$element.style.transition = 'opacity 0.3s 0.1s'
        ...
        this.touch.right.$icon.style.top = 'calc(50% - 11px)'
        this.touch.right.$icon.style.left = 'calc(50% - 9px)'
        this.touch.right.$icon.style.width = '18px'
        this.touch.right.$icon.style.height = '22px'
