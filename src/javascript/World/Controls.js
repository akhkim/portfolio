...
export default class Controls extends EventEmitter
{
    ...
    setTouch()
    {
        ...
        this.touch.left.$element.style.bottom = '10px'
        this.touch.left.$element.style.left = '10px'
        this.touch.left.$element.style.width = '70px'
        this.touch.left.$element.style.height = '70px'
        this.touch.left.$element.style.transition = 'opacity 0.3s 0.0s'
        ...
        this.touch.left.$border.style.top = '0'
        this.touch.left.$border.style.left = '0'
        this.touch.left.$border.style.width = '100%'
        this.touch.left.$border.style.height = '100%'
        ...
        this.touch.left.$icon.style.transform = 'rotate(-90deg)'
        ...
        this.touch.right.$element.style.bottom = '10px'
        this.touch.right.$element.style.left = '90px'
        this.touch.right.$element.style.width = '70px'
        this.touch.right.$element.style.height = '70px'
        this.touch.right.$element.style.transition = 'opacity 0.3s 0.0s'
        ...
        this.touch.right.$border.style.top = '0'
        this.touch.right.$border.style.left = '0'
        this.touch.right.$border.style.width = '100%'
        this.touch.right.$border.style.height = '100%'
