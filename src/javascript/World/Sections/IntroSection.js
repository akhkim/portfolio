...
export default class IntroSection
{
    ...
    setOtherInstructions()
    {
        ...
        this.otherInstructions.x = - 5
        this.otherInstructions.y = 0
    ...
    setTitles()
    {
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(0, 17.5, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 0.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
            soundName: 'brick'
        })
        this.objects.add({
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(0, 17.5, 0.75),
            rotation: new THREE.Euler(0, 0, 0),
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(0.12, 17.5, 0.75),
            rotation: new THREE.Euler(0, 0, 0),
    ...
    setDikes()
    {
        ...
        this.walls.add({
            ...
            shape:
            {
                ...
                widthCount: 5,
                heightCount: 2,
                position: new THREE.Vector3(this.x - 12, this.y - 7, 0),
        ...
        this.walls.add({
            ...
            shape:
            {
                ...
                widthCount: 3,
                heightCount: 2,
                position: new THREE.Vector3(this.x + 5, this.y - 18.5, 0),
                offsetWidth: new THREE.Vector3(1.05, 0, 0),
                offsetHeight: new THREE.Vector3(0, 0, 0.45),
                randomOffset: new THREE.Vector3(0, 0, 0),
                randomRotation: new THREE.Vector3(0, 0, 0.2)
        ...
        this.walls.add({
            ...
            shape:
            {
                ...
                widthCount: 3,
                heightCount: 2,
                position: new THREE.Vector3(this.x - 12, this.y -14.5, 0),
                offsetWidth: new THREE.Vector3(0, - 1.05, 0),
                offsetHeight: new THREE.Vector3(0, 0, 0.45),
                randomOffset: new THREE.Vector3(0, 0, 0),
                randomRotation: new THREE.Vector3(0, 0, 0.2)
        ...
        this.walls.add({
            ...
            shape:
            {
                ...
                widthCount: 3,
                heightCount: 2,
                position: new THREE.Vector3(this.x + 9, this.y + 2, 0),
                offsetWidth: new THREE.Vector3(1.05, 0, 0),
                offsetHeight: new THREE.Vector3(0, 0, 0.45),
                randomOffset: new THREE.Vector3(0, 0, 0),
                randomRotation: new THREE.Vector3(0, 0, 0.2)
        ...
        this.walls.add({
            ...
            shape:
            {
                ...
                widthCount: 3,
                heightCount: 2,
                position: new THREE.Vector3(this.x + 10.8, this.y + 0.7, 0),
                offsetWidth: new THREE.Vector3(0, - 1.05, 0),
                offsetHeight: new THREE.Vector3(0, 0, 0.45),
                randomOffset: new THREE.Vector3(0, 0, 0),
                randomRotation: new THREE.Vector3(0, 0, 0.2)
        ...
        this.walls.add({
            ...
            shape:
            {
                ...
                widthCount: 3,
                heightCount: 2,
                position: new THREE.Vector3(this.x + 10, this.y - 12, 0),
                offsetWidth: new THREE.Vector3(0, - 1.05, 0),
                offsetHeight: new THREE.Vector3(0, 0, 0.45),
                randomOffset: new THREE.Vector3(0, 0, 0),
                randomRotation: new THREE.Vector3(0, 0, 0.2)
